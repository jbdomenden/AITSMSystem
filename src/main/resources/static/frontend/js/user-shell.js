...
function toggleUserNotifMenu() {
  document.getElementById('userNotifMenu')?.classList.toggle('hidden');
}
...
function renderUserUtilityHeader() {
  ...
  host.innerHTML = `
    <div class='utility-left'>
      ...
      <a class='utility-brand' href='/dashboard-user.html' aria-label='Go to workspace overview'>AITSM Workspace</a>
    </div>
    <div class='utility-right'>
      <button id='userNotifTrigger' class='btn btn-ghost icon-btn header-icon-btn notif-trigger-btn' type='button' onclick='toggleUserNotifMenu()' aria-label='Notifications' title='Notifications'>${userIcon('bell')}<span id='userNotifCount' class='notif-count'>0</span></button>
