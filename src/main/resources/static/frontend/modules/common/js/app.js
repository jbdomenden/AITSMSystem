...
function enforcePageAccess() {
  ...
  const adminOnlyPages = ['dashboard-admin.html', 'ticket-management.html', 'monitoring.html', 'inventory.html', 'assets.html', 'settings.html', 'profile.html', 'user-management.html', 'knowledge.html'];
